...
public record DecreaseProductStockRequestDto(Long productId, Long optionId,
                                             Long decreaseStockAmount) {

    public static DecreaseProductStockRequestDto from(Long productId, Long optionId,
        Long decreaseStockAmount) {
