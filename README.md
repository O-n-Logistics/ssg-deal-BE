...
| MSA              | Spring Cloud (Eureka, Gateway, Config)        |
| ORM              | JPA, QueryDSL                                 |
| 데이터베이스     | MySQL, Redis                                  |
| 메시징           | Kafka                                         |
| 인증             | JWT, Passport Token                           |
| 배포             | AWS ECS (EC2, Fargate), ECR, Naver Cloud, 개인 서버 |
| 모니터링         | CloudWatch                                    |
| CI/CD           | GitHub Actions                                |
| 분산 트랜잭션    | Zipkin                                        |
| 외부 연동 API    | Slack, Toss Payments                          |
| 기타             | Lua Script (Redis Lock), Docker               |
| 형상 관리        | GitHub                                        |
